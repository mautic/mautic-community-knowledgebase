...
Emails can be validated using different methods such as [sending emails using java](https://blog.mailtrap.io/sending-email-using-java/), using javascript to validate email addresses etc. 
